...
global.reloadHandler = function () {
  ...
  conn.welcome = 'Hai @user\n◪ Welcome in group:\n├─ @subject\n├─ Intro dulu\n├─ ❏ Nama: \n├─ ❏ Umur: \n├─ ❏ Asal kota: \n├─ ❏ Kelas: \n├─ ❏ Jenis kelamin: \nJangan lupa donasi Ya kak biar bot berjalan terus sama beli premium bot Ya'
  conn.bye = 'Selamat Tinggal @user!\nTerimakasih Telah Bergabung Di Grup ini\n\nKalo Balik lagi Jangan Lupa Beli premium bot Ya'
